...
read -p "是否添加Flatpak国内源到系统目录？[y/N]" -t 5 choice
case $choice in
...
# 排查网络
# OSTREE_DEBUG_HTTP=1 flatpak install org.kde.kdenlive
